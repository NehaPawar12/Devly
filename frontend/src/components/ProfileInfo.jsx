...
const ProfileInfo = () => {
	const userProfile = {
		avatar_url: "https://img.freepik.com/free-vector/smiling-woman-with-braided-hair_1308-174961.jpg?ga=GA1.1.475717472.1736048471&semt=ais_hybrid",
		bio: "👨🏻‍💻👨🏻‍💻👨🏻‍💻",
		email: "neha@gmail.com",
		followers: 100,
		following: 200,
		html_url: "https://github.com/NehaPawar12",
		location: "India",
		name: "Neha Pawar",
		public_gists: 100,
		public_repos: 100,
		twitter_username: "neha",
		login: "neha",
	};
	...
	return (
		<div className='lg:w-1/3 w-full flex flex-col gap-2 md:sticky md:top-10'>
			<div className='bg-glass rounded-lg p-4'>
				...
				{/* Member Since Date */}
				<div className='my-2'>
					<p className='text-cyan-300 font-bold text-sm'>Member since</p>
				...
				{userProfile?.email && (
					<div className='my-2'>
						<p className='text-cyan-300 font-bold text-sm'>Email address</p>
				...
				{userProfile?.name && (
					<div className='my-2'>
						<p className='text-cyan-300 font-bold text-sm'>Full name</p>
				...
				{/* Username */}
				<div className='my-2'>
					<p className='text-cyan-300 font-bold text-sm'>Username</p>
