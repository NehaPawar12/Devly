    ...
    <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0'>
      <div className='w-full rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 bg-glass'>
        <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
          ...
          <h1 className='text-xl front-bold md:text-2xl text-center'>Create Account</h1>
          ...
          <button type='button' className='text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4
						...
						text-center justify-center' onClick={handleLoginWithGithub} >
              <FaGithub className='size-5'/>
              Sign up with Github
            </button>

            <p className='text-gray-300'>
						By signing up, you will unlock all the features of the Devly.
						<span>
