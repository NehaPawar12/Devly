    ...
    <div className='px-4'>
			<div className='bg-glass max-w-2xl mx-auto rounded-md p-4'>
				...
				<div className='flex flex-wrap gap-2 my-2 justify-center'>
					<img src='/javascript.svg' alt='JavaScript' className='h-11 sm:h-20 cursor-pointer' onClick={() => exploreRepos("javascript")} />
					...
					<img src='/Kotlin.svg' alt='Kotlin logo' className='h-11 sm:h-20 cursor-pointer' onClick={() => exploreRepos("Kotlin")} />
				</div>
				{
					repos.length > 0 && (
